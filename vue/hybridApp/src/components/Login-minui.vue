  ...
  <page :title = "$options.cnName" :right-slot="'disable'">
    <mt-tab-container v-model="active" class="hy-default-content-bg">
      <mt-tab-container-item id="smsLogin">
        <mt-cell title="手机号登录"><i slot="icon" class="fa fa-cog fa-fw" aria-hidden="true"></i></mt-cell>
        ...
        <mt-cell><span>未注册华艺的手机号，登录时将自动注册</span></mt-cell>
    ...
    <mt-button class="hy-default-button" type="primary" size="large" @click="login">登录</mt-button>
