...
public class DateUtils {
	...
	public static String getCurrDate() {
		...
		DateFormat df = new SimpleDateFormat(DateUtils.DATETIME_FORMATE);
	...
	public static String getCurrentAround(String format, int str) {
		...
		return DateUtils.calendarToString(calendar, DateUtils.DATETIME_FORMATE);
	}
	...
	public static void main(String[] args) {
		Long l = dateDiff("2016-11-21", "2016-11-20", DateUtils.DATE_FORMATE, "day");
	...
	// 日期加一个分钟后的日期代码
	public static String addDateSecond(String day, int x) {
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");// 24小时制
		Date date = null;
		try {
			date = format.parse(day);
	 ...
	 * @param unit: 'day','h','m','s'
	 * @return
	 */
	public static Long getTimeToNextMidNight(Date date,String unit) {
